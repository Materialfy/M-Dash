<template>
	<v-footer id="core-footer" color="primary" app absolute height="82">
		<div class="ma-2">
		...
		<span class="font-weight-light copyright">
			...
			<a href="https://twitter.com/SourBlueDream" target="_blank" class="ma-2">@SBD</a> V.Dashboard by Materialfy, crafted
			with Vuetify
