	...
	<v-container fill-height container--fluid grid-list-xl>
		<v-layout wrap>
			<v-flex md12 sm12 lg4>
				<materialfy-chart-card
					:data="dailySalesChart.data"
					:options="dailySalesChart.options"
					color="warning"
					type="Line"
				>
					<h4 class="text-h6 font-weight-light">Daily StackOverflow Visits</h4>
					...
					<template slot="actions">
						...
						<span class="text-caption grey-lighten-1--text font-weight-light"
			...
			<v-flex md12 sm12 lg4>
				...
				>
					...
					<template slot="actions">
						<v-icon class="mr-2" small> mdi-clock-outline </v-icon>
						<span class="text-caption blue-grey--text font-weight-light"
			...
			<v-flex md12 sm12 lg4>
				<materialfy-chart-card
					...
					type="Line"
				>
					<h3 class="text-h6 font-weight-light">Completed Tasks</h3>
					<p class="category d-inline-flex font-weight-light">
			...
			<v-flex md12 lg6>
				<materialfy-card class="card-tabs" color="general">
