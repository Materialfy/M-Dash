        ...
        <material-card class="v-card-profile">
          ...
          <v-card-text class="text-center">
            ...
            <p class="card-description font-weight-light">
              You wrote that yourself? wow congrats dude, really, that's very cool.
              ...
              porticos, ballons, colossal boom speakers, anything that can make your name stand out more and see which city can congratulate you the hardest for this magnificent feat.
            </p>
            <v-btn
              color="general"
              rounded
